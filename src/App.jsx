          ...
          <div className="relative w-auto my-6 mx-auto max-w-3xl">
            ...
            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white">
              ...
              <div className="flex justify-between p-6 border-t border-solid border-slate-200 rounded-b space-x-2">
                ...
                <button
                  className="text-red-500 font-bold uppercase px-6 py-2 text-sm mr-1 mb-1 ease-linear transition-all duration-150"
                  type="button"
      ...
      <div className="container mx-auto px-4 sm:px-8">
        ...
        <div className="p-5  rounded-lg">
              ...
              <div className="flex flex-row">
                ...
                {loading ? (
                  <div role="status">
                    <svg
                      aria-hidden="true"
                      className="w-6 h-8 ml-2  text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
                      viewBox="0 0 100 101"
                      fill="none"
          ...
          <div className="mb-4  flex flex-row">
            <label htmlFor="currency" className="m-2 rounded-md">
